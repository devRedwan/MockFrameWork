...
//		System.out.println(locdepartltr);
	...
	//	else                                   {System.out.println("PASS: Guests textbox rejects letters");}
		if(txtverify(loc.passenger, val.tc03txtbxletters)){
			System.out.println("FAIL: Guests textbox allows letters");
		}
		else{
			System.out.println("PASS: Guests textbox rejects letters");
		}
	}
